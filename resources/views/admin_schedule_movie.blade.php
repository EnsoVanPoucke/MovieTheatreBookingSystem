...
<div class="mx-auto max-w-5xl p-6 sm:px-6 lg:px-8">

	<h1 class="text-3xl font-bold my-5">Scheduler</h1>
	...
	<div class="border border-gray-900/10 rounded-md px-12">
		...
		<form action="{{ route('schedule.movie') }}" method="POST" enctype="multipart/form-data">
			@csrf
			...
			<div class="py-12">
					...
					<div class="col-span-4">
						...
						<div class="mt-0">
							<textarea name="description"
								id="description"
								rows="5"
								class="block w-full rounded-sm bg-white text-base text-gray-900 text-sm/6 py-1 px-2"></textarea>
						</div>
					</div>
				</div>
				...
				<div class="mt-4 grid grid-cols-4 gap-x-4 gap-y-4">
					<div class="col-span-2">
						<x-form-label for="image_url">Image url</x-form-label>
						<x-form-input id="image_url" name="image_url" type="text" />
					</div>
					<div class="col-span-2">
			...
			<div class="py-12">
				...
				<div class="mt-4 grid grid-cols-4 gap-x-4 gap-y-4">
					<div class="col-span-1">
						<x-form-label for="show_date">Show date</x-form-label>
						<x-form-input id="show_date" name="show_date" type="date" />
					</div>
					<div class="col-span-1">
						<x-form-label for="show_time">Show time</x-form-label>
						<x-form-input id="show_time" name="show_time" type="time" />
					</div>
					<div class="col-span-1">
						<x-form-label for="screenroom">Screenroom</x-form-label>
						<x-form-input id="screenroom" name="screenroom" type="number" />
					</div>
				</div>
			</div>
