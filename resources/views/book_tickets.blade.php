...
<div class="container my-4">
	<div class="bg-light py-6 px-4">
		...
		<h2 class="text-2xl font-semibold mb-4">Screening Details</h2>
		<p><strong>Datum:</strong> {{ \Carbon\Carbon::parse($screening->screening_date)->format('l d M Y') }}</p>
		<p><strong>Tijd:</strong> {{ \Carbon\Carbon::parse($screening->screening_time)->format('H:i') }}</p>
		<p><strong>Zaal:</strong> {{ $screening->screen_number }}</p>
		...
		<form>
			...
			<div class="grid grid-cols-4 gap-4">
				...
				<div class="col-span-1">
					<img src="{{ asset('images/movieposters/' . $screening->movie->poster_url) }}"
				alt="{{ $screening->movie->title }} Image"
				class="mt-4">
			</div>
			...
			<div class="col-span-3">
				...
				<div class="grid grid-cols-5 border-t border-gray-900/20 py-4 mt-4">
					...
					<div class=" price-item-container col-span-1 flex items-center">
						<h2 class="text-xl font-semibold text-gray-700/100">{{ number_format($screening->movie->tarief_single_normaal / 100, 2, ',', '.') }} &euro;</h2>
					</div>
				...
				<div class="grid grid-cols-5 border-t border-gray-900/20 py-4">
					...
					<div class=" price-item-container col-span-1 flex items-center">
						<h2 class="text-xl font-semibold text-gray-700/100">{{ number_format($screening->movie->tarief_single_korting / 100, 2, ',', '.') }} &euro;</h2>
					</div>
					<!-- Showtime date select options -->
					<div class="col-span-1">
						<div class="grid col-span-2">
				...
				<div class="grid grid-cols-5 border-t border-gray-900/20 py-4">
					...
					<div class=" price-item-container col-span-1 flex items-center">
						<h2 class="text-xl font-semibold text-gray-700/100">{{ number_format($screening->movie->tarief_duo_normaal / 100, 2, ',', '.') }} &euro;</h2>
					</div>
					<!-- Showtime date select options -->
					<div class="col-span-1">
						<div class="grid col-span-2">
				...
				<div class="grid grid-cols-5 border-t border-gray-900/20 py-4">
					...
					<div class=" price-item-container col-span-1 flex items-center">
						<h2 class="text-xl font-semibold text-gray-700/100">{{ number_format($screening->movie->tarief_duo_korting / 100, 2, ',', '.') }} &euro;</h2>
					</div>
					<!-- Showtime date select options -->
					<div class="col-span-1">
						<div class="grid col-span-2">
...
<script>
	...
	// 		const priceSingleNormaal = parseInt("{{ $screening->movie->tarief_single_normaal }}");
// const priceSingleKorting = parseInt("{{ $screening->movie->tarief_single_korting }}");
// const priceDuoNormaal = parseInt("{{ $screening->movie->tarief_duo_normaal }}");
// const priceDuoKorting = parseInt("{{ $screening->movie->tarief_duo_korting }}");
