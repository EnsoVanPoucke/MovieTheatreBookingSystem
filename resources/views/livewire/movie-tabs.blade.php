<div>
	...
	<div class="bg-gray-200">
		<div class="mx-auto max-w-5xl py-8 sm:px-6 lg:px-8 flex gap-3">
			<button
				class="{{ $filter === 'allefilms' ? 'bg-orange-600 text-white' : 'bg-white text-orange-600' }} 
                text-sm font-semibold border-2 border-orange-600 py-2 px-4 hover:bg-orange-600 hover:text-white flex items-center gap-2"
				wire:click="setFilter('allefilms')">
				@if($filter === 'allefilms')
			...
			<button
				class="{{ $filter === 'vandaag' ? 'bg-orange-600 text-white' : 'bg-white text-orange-600' }} 
                text-sm font-semibold border-2 border-orange-600 py-2 px-4 hover:bg-orange-600 hover:text-white flex items-center gap-2"
				wire:click="setFilter('vandaag')">
				@if($filter === 'vandaag')
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="w-5 h-5">
					<path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
				</svg>
			...
			<button
				class="{{ $filter === 'morgen' ? 'bg-orange-600 text-white' : 'bg-white text-orange-600' }} 
                text-sm font-semibold border-2 border-orange-600 py-2 px-4 hover:bg-orange-600 hover:text-white flex items-center gap-2"
				wire:click="setFilter('morgen')">
				@if($filter === 'morgen')
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="w-5 h-5">
					<path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
				</svg>
